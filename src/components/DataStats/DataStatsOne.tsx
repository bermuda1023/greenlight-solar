...
const dataStatsList = [
  {
    ...
    value: "1.23K",
    growthRate: 1.2, // Positive growth
  },
  {
    icon: (
      <svg
    ...
    value: "4.5K",
    growthRate: 3.1, // Positive growth
  },
  {
    icon: (
      <svg
    ...
    value: "250",
    growthRate: -1.8, // Negative growth
  },
];
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
      {dataStatsList.map((item, index) => (
        <div
          key={index}
          className="rounded-[10px] bg-white px-4 py-6 shadow-1 dark:bg-gray-dark"
        >
