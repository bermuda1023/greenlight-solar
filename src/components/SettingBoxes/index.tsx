...
const SettingBoxes = () => {
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <button className="hover:bg-primary-dark rounded-md bg-primary px-4 py-2 text-white">
          <i className="fas fa-plus"></i>Edit Info
        </button>
      </div>
    ...
    <div className="relative">
      ...
      <p 
      className="w-full rounded-[7px] bg-primary/[.07] py-2.5 pl-12.5 pr-4.5 text-dark dark:text-white"
>      Devid Jhon
      </p>
    </div>
  </div>
 ...
 ac suscipit diam sem a felis. Cras sapien ex, blandit eu dui et suscipit gravida nunc. Sed sed est quis dui."
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 2C7.79086 2 6 3.79086 6 6V8H4C3.44772 8 3 8.44772 3 9V17C3 17.5523 3.44772 18 4 18H16C16.5523 18 17 17.5523 17 17V9C17 8.44772 16.5523 8 16 8H14V6C14 3.79086 12.2091 2 10 2ZM7.5 6C7.5 4.61929 8.61929 3.5 10 3.5C11.3807 3.5 12.5 4.61929 12.5 6V8H7.5V6ZM5 9.5H15V16.5H5V9.5ZM9.5 12C9.5 11.7239 9.72386 11.5 10 11.5C10.2761 11.5 10.5 11.7239 10.5 12V14C10.5 14.2761 10.2761 14.5 10 14.5C9.72386 14.5 9.5 14.2761 9.5 14V12Z"
      fill=""
    />
  </svg>
</span>
