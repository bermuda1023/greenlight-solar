interface BillCalculationResult {
  ...
  export const calculateSolarBill = (params: {
    ...
    else if (dailyAverage <= 15) facilityCharge = 32.00;
    ...
    const savings = totalBelcoCost - greenlightRevenue + fixedFeeSaving - remainingConsumptionCost;
  ...
  function calculateBelcoCost(
    ...
    else if (dailyAverage <= 15) cost += 32.00;
